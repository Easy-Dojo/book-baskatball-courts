...
describe("test authorizeSlice reducer", () => {
    ...
    it("should return correct data when trigger doLogin given action is pending", () => {
    ...
    it("should return correct data when trigger doLogin given action is fulfilled", () => {
    ...
    it("should return correct data when trigger doLogin given action is rejected", () => {
