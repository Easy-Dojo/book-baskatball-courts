...
describe("test message reducer", () => {
    ...
    it("should return correct data when trigger fetchMessage given action is pending", () => {
    ...
    it("should return correct data when trigger fetchMessage given action is fulfilled", () => {
    ...
    it("should return correct data when trigger fetchMessage given action is rejected", () => {
